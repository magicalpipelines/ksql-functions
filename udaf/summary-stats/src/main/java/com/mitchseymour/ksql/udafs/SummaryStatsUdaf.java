package com.mitchseymour.ksql.udafs;
 ...
 * Example query usage:
 *
 * CREATE STREAM api_responses (ip VARCHAR, endpoint VARCHAR, response_code INT, response_time DOUBLE) \
...
@UdafDescription(
  name = "summary_stats",
  description = "Compute summary statistics for a stream of data"
)
public class SummaryStatsUdaf {

  @UdafFactory(description = "Compute summary statistics for a stream of doubles")
